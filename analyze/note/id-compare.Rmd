...
sets <- list("detentions" = detention_ids,
             "arrests" = arrest_ids,
...
detention_df <- detention_df %>% 
  mutate(book_in_fy = substr(quarter(book_in_date_time, fiscal_start = 10, type = "year.quarter"), 1, 4),
         stay_book_in_fy = substr(quarter(stay_book_in_date_time, fiscal_start = 10, type = "year.quarter"), 1, 4))

hist(as.numeric(detention_df$book_in_fy))
