...
id_lookup("b0d85d7b0ea028f6bd6d8557aa1f2f2fbd047a90", arrest_df, output="text")
...
dat <-lookup_enforcement("b0d85d7b0ea028f6bd6d8557aa1f2f2fbd047a90")

write_delim(dat, here::here('analyze/output/b0d85d7b0ea028f6bd6d8557aa1f2f2fbd047a90.csv'), delim=',')
```
