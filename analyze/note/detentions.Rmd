...
first_reported_placement <- df %>% 
  dplyr::select(unique_identifier, stayid, stay_book_in_date_time, book_in_date_time, initial_placement_exact, initial_placement_approx, placement_count) %>% 
...
length(unique(gtmo$unique_identifier))
sum(gtmo$id_in_arr)
