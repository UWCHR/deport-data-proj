...
headcount <- read_delim(here::here('detain-headcount', 'output', 'headcount_detloc_nov23-jun25.csv.gz'), delim="|")
...
p1 <- cscnwwa %>% 
  ...
  geom_line() +
  geom_hline(yintercept = 1575, color="red") +
  ylim(0, NA) +
  labs(title = "NWDC population, Nov. 2023 - Jun. 2025")
